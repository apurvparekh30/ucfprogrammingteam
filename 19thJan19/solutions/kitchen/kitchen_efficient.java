/*  ACM Mid-Central Programming competition 2015 Problem E: Kitchen Measurements
    ...
    is to be modified as invalid (index=NONE) but leave it in the queue,
...
public class kitchen_efficient {
...
class jugs implements Comparable<jugs> {  // equals is default - same object
   ...
   static int solve()
   {
      ...
      while (true) {
         ...
         if (closest.index == NONE) continue; //kludge for no decreaseKey
         closest.getV(v);
         if (v[0] == V) {
