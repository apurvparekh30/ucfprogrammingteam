...
(function(){
    ...
    (function() {
    var p = "3398543", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3398543||'',
    GUID:window.ftGUID_3398543||'99999999999',
    confID:window.ftConfID_3398543||'0',
    ftReturn: window.ftReturn_3398543||'',
    keyword:window.ftKeyword_3398543||'',
    ftId:window.ftId_3398543||'',
    imp:window.ftImp3398543,
    ftImpId:window.ftImp3398543 && window.ftImp3398543.impID || '',
    campaignID:'98692',
    cID:'86652',
    pID:'3398543',
    creativeID:'2514900',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1000798&cmp=98692&sid=17304&plc=3398543&num=&adid=&advid=1487&adsrv=29&region=30&btreg=/3398543/&btadsrv=flashtalking&crt=2514900&crtname=&chnl=&unit=&pid=&uid=&tagtype=&dvtagver=6.1.src"],
    clickTags: ["http://servedby.flashtalking.com/click/8/98692;3398543;2514900;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://disneyworld.disney.go.com/special-offers/resident-discover/"],
    placementDescription:'DOUBLECLICKDOUBLECLICK2018100120190930160x600MULFPTKTACTMGNGMRESENGSM684ActivateSimilarAudiencesDBM160x600PTK1BY',
    width:160,
    height:600,
    ...
    divID:'ftdiv3398543',
    phID:'ftpos3398543',
    frameID:'ftframe3398543',
    expID:'ftexpframe3398543',
    altImgID:'ftalt3398543',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/98692;3398543;2514900;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://disneyworld.disney.go.com/special-offers/resident-discover/',
    altImg:'http://servedby.flashtalking.com/imp/8/98692;3398543;204;gif;GoogleMarketingPlatform;DOUBLECLICKDOUBLECLICK2018100120190930160x600MULFPTKTACTMGNGMRESENGSM684ActivateSimilarAudiencesDBM160x600PTK1BY/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/98692;3398543;271;pixel;GoogleMarketingPlatform;DOUBLECLICKDOUBLECLICK2018100120190930160x600MULFPTKTACTMGNGMRESENGSM684ActivateSimilarAudiencesDBM160x600PTK1BY/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/339/3398543/2514900/js/j-3398543-2514900.js',
    file:'http://cdn.flashtalking.com/86652/2514900/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?130171240-3398543;2514900;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_3398543||'',
    segmentList:window.ftSegmentList_3398543||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3398543 && window.ftImp3398543.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3398543')&&/^https:/.test(document.getElementById('ftscript_m3398543').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3398543'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3398543'],
        ['ftcfid', 'ftConfID_3398543'],
        ['fttime', 'ftTimestamp_3398543'],
        ['ftsection', 'ftSection_3398543'],
        ['ftcustom', 'ftCustom_3398543'],
        ['ft_id', 'ftId_3398543'],
        ['ftimpid','ftImp3398543', 'impID']
    ]
};
...
//2018_12_26
//ftMinified
ft3398543.encodeClickCount = parseInt('1', 10) || 0;

ft3398543.addVClick = function(ct) {
    var o = this;
    ...
    dcmCustom = dcmCustom.split('_');
    var newFtCustom = [];
    var thisCreativeID = o.creativeID
    var thisVersionID = o.confID

    newFtCustom.push(dcmCustom[2], dcmCustom[3], thisCreativeID, thisVersionID);
